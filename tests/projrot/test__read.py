...
def test__reader():
    ...
    real_freqs1, imag_freqs1 = projrot_io._read.read_rpht_output(min_freqs_file)
    real_freqs2, imag_freqs2 = projrot_io._read.read_rpht_output(one_imag_freqs_file)
    real_freqs3, imag_freqs3 = projrot_io._read.read_rpht_output(two_imag_freqs_file)
